...
export function voiceInstructions(profile) {
  ...
  return `
Personality must affect both what this person chooses to say and how they phrase it. Use their particular values, temperament, interests and relationship to decide which aspect matters to them; do not merely insert a profession reference or label an emotion. Do not describe your own traits.
